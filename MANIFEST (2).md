...
---
Status: **Phase 2 complete. Task 1/28 done.** Say "do task N" to continue
(suggested next: Task 2a — borrow-window fields on admin_rooms.js create/update,
since it only needs the `room_tags` column names above, not full file context).
